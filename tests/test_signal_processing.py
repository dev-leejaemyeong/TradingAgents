...
class TestSignalProcessor:
    ...
    def test_unparseable_signal_is_review_not_silent_hold(self):
        # Upstream #1170: an unrecognizable decision must surface REVIEW, not a
        # fabricated tradeable Hold.
        sp = SignalProcessor()
    ...
    def test_fullwidth_colon_is_parsed_not_reviewed(self):
        # Upstream #1170: `Rating：Overweight` (fullwidth colon) used to defeat
        # the regex and silently become Hold; NFKC normalization now parses it.
        sp = SignalProcessor()
