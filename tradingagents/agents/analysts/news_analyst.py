...
def create_news_analyst(llm):
    def news_analyst_node(state):
        ...
        system_message = (
            ...
            + """ If a tool result contains a NO_DATA_AVAILABLE or DATA_UNAVAILABLE notice, or otherwise indicates missing or failed data, state that limitation explicitly in your report instead of writing around it -- never fabricate news or figures to fill the gap."""
