...
class SignalProcessor:
    ...
    def process_signal(self, full_signal: str) -> str:
        ...
        tradeable neutral signal (upstream #1170, ported 2026-09-08). Consumers
        that map the result onto the 5-tier enum should guard with
        :func:`~tradingagents.agents.utils.rating.is_review`.
        """
